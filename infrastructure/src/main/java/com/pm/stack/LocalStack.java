...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService(
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWt_SECRET", "139723f85254d1f9b31599707805c603ed7e360b068a4f1fb0399c93a479c249"));
    ...
    // e.x. auth-service.patient-management.local
    // e.x. billing-service.patient-management.local
    ...
    private FargateService createFargateService(
        ...
        envVars.put("SPRING_DATA_REDIS_HOST", elastiCacheCluster.getAttrConfigurationEndpointAddress());
        envVars.put("SPRING_DATA_REDIS_PORT", elastiCacheCluster.getAttrConfigurationEndpointPort());
        ...
        return FargateService.Builder.create(this, id)
                ...
                .cloudMapOptions(CloudMapOptions.builder()
                        .name(imageName) // patient-service.patient-management.local
